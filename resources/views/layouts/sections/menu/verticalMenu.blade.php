...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item active">
            <a href="{{route('account')}}" class="menu-link">
              <div data-i18n="Account">Capital</div>
            </a>
          </li>
        </ul>
      @endif
    ...
    <li class="menu-header small text-uppercase">
        <span class="menu-header-text">Company's</span>
    </li>
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('supplier.index') }}" class="menu-link">
              <div data-i18n="Collapsed menu">Details</div>
            </a>
          </li>

          <li class="menu-item">
            <a href="{{ route('transactionNaviagtion.index') }}" class="menu-link">
              <div data-i18n="Collapsed menu">Make Transaction</div>
            </a>
          </li>

          <li class="menu-item">
            <a href="{{ route('transaction.index') }}" class="menu-link">
              <div data-i18n="Collapsed menu">All Transaction</div>
            </a>
          </li>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons ti ti-asset"></i>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons ti ti-manual-gearbox"></i>
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('partner.index') }}" class="menu-link">
              <div data-i18n="Collapsed menu">Partner's List</div>
            </a>
          </li>

          <li class="menu-item">
            <a href="{{ route('partner.create') }}" class="menu-link">
              <div data-i18n="Collapsed menu">Add new</div>
            </a>
          </li>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div data-i18n="Labours">Labours</div>
        </a>

        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('labour.index') }}" class="menu-link">
              <div data-i18n="Collapsed menu">Labour's List</div>
            </a>
          </li>

          <li class="menu-item">
            <a href="{{ route('labour.create') }}" class="menu-link">
              <div data-i18n="Collapsed menu">Add new</div>
            </a>
          </li>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div data-i18n="Salaries">Salaries</div>
        </a>

        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('salary.index') }}" class="menu-link">
              <div data-i18n="Collapsed menu">Salary List</div>
            </a>
          </li>

          <li class="menu-item">
            <a href="{{ route('salary.create') }}" class="menu-link">
              <div data-i18n="Collapsed menu">Make new</div>
            </a>
          </li>
