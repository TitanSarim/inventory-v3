            ...
            @method('PUT')
                ...
                <div class="card-body">
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6" id="other_input_b">
                      <label for="name"  class="form-label">Transaction To & From*</label>
                      <input type="text" id="payment_to_from" name="payment_to_from" class="form-control form-control-lg" readonly value="{{ $transaction->payment_to_from}}">
                      @error('payment_to_from')
                    ...
                    <div class="col-md-6">
                      <label for="payment_to_from" class="form-label">By</label>
                          <select class="form-select form-select-lg" name="using" id="using">
                              <option selected>{{ $transaction->using}}</option>
                              <option>Cash</option>
                              <option>Card</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" required="required" id="amount" name="amount" class="form-control form-control-lg" value="{{ $transaction->amount}}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-lg" value="{{ $transaction->transaction_date_time}}" id="flatpickr-date" name="transaction_date_time"/>
